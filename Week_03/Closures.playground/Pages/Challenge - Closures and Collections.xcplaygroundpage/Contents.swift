...
let classLibraryBooks2 = students.map { (student) -> [String] in
...
let classPets2 = students.compactMap { (student) -> String? in
    student.pet
}

let classPets3 = students.compactMap { $0.pet }
...
classLibraryBooks2.flatMap { $0 }

var flatBooks = classLibraryBooks2.flatMap { book in
    book
}
print(flatBooks)

let classLibraryBooks3 = students.flatMap { (student) -> [String] in
    student.libraryBooks
}

print(classLibraryBooks3)
